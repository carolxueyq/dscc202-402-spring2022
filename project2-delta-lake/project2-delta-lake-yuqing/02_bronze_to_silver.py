...
display(
  bronzeDF.groupby("datasource").agg(count("*")),
...
assert ddl_schema == _parse_datatype_string("device_id integer, heartrate double, eventtime timestamp, name string, p_eventdate date"), "File not present in Silver Path"
print("Assertion passed.")
